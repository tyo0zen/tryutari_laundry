...
class c_transaksi
{
    ...
    function bayar($id, $tanggal_bayar, $bayar)
    {
        ...
        $sql = "UPDATE tb_transaksi SET  tanggal_bayar='$tanggal_bayar', dibayar='$bayar' WHERE id='$id'";
