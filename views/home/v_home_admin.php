...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/isihome.css">
</head>
...
<div class="container">
    <div class="row">
        <div class="col-md-8">
        <img class="home-image" src="../../assets/images/TrollFace.jpg" alt="">
        </div>

        <div class="col-md-4">
        <h1>KERJA, KERJA, KERJA!!!</h1>
        <p class="ukuran">laundry kita menjunjung perbudakan, tidak ada libur kecuali meninggal.</p>
        </div>
    </div>
</div>
